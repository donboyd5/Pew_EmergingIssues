...
One advantage of these data is that unlike several other hazard databases, the NRI database includes estimates of the "statistical" value of injury and loss of life.
...
tab <- tabdata |> 
  ...
  gt() |> 
  # tab_header(
  #   title = html("Estimated Annual Loss From Natural Disasters"),
